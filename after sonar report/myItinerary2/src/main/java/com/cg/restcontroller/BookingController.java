...
public class BookingController {
	...
	private static final String BOOKING_FAILED = "Resort booking failed for a Guest.";
	private static final String BOOKED = "Resort Booked for a Guest and bookedResort Entity returned.";
	@Autowired
	...
	@ApiOperation(value = "Returns a Resort Entity with status code.")
	...
	/* Dining */
	@ApiOperation(value = "Returns a Dining Entity with status code.")
	@ApiResponses(value = { @ApiResponse(code = 201, message = "CREATED"),
			@ApiResponse(code = 400, message = "BAD_REQUEST") })
